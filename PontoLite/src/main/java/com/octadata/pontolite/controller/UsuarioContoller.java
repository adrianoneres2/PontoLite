...
public class UsuarioContoller {
	...
	public String processarFormularioCadastro(@ModelAttribute @Valid Usuario usuario, BindingResult bindingResult, Model model) {
        ...
        try{
			...
			usuario.setCliente(usuario.getCliente()==null ? autenticacaoService.getUsuarioAutenticado().getCliente() : usuario.getCliente());
	...
	@GetMapping("/listar")
	public String listar(@RequestParam(name = "codCliente", required = true, defaultValue = "0") Long codigoCliente, Model model) {
		codigoCliente = codigoCliente == 0 ? autenticacaoService.getUsuarioAutenticado().getCliente().getCodigoCliente() : codigoCliente;
    ...
    @PostMapping("/alterar")
    public String processarFormularioAlteracao(@ModelAttribute @Valid Usuario usuario, BindingResult bindingResult, Model model) {
        if (bindingResult.hasErrors()) {
        	model.addAttribute("org.springframework.validation.BindingResult.usuario", bindingResult);
